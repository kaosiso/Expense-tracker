    ...
    <div className="flex justify-center mb-6">
      ...
      {!image ? (
        ...
        <div className="relative">
          ...
          <button type="button" className="w-8 h-8 flex items-center justify-center bg-red-500 text-white rounded-full absolute -bottom-1 -right-1 " onClick={handleImageChange}>
            <LuTrash />
          </button>
        </div>
      )}
